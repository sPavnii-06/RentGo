...
* **Instant Visual Preview Canvas:** Selecting any car from inventory list instantly renders a high-resolution image of that specific vehicle model on the main dashboard.
